...
},{}],"review.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(review, rating, product_id) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/product/".concat(product_id, "/review"),
              data: {
                review: review,
                rating: rating
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your review successfully added');
            }
...
document.querySelector('.submit__review').addEventListener('click', function (e) {
  e.preventDefault();
  var review = document.querySelector('.review__input').value;
  var rating = document.querySelector('.review__rate').value;
  var product_id = document.querySelector('.add__review').dataset.product_id;
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","review.js"], null)
//# sourceMappingURL=/reviewbundle.js.map